...
import BlowMyBack from "./blowMyBack";
...
export default class Server {
	...
	private registerRoutes(): void {
		...
		const bb = new BlowMyBack();
		this.express.get("/echo/:msg", Server.echo);

		// TODO: your other endpoints should go here
		this.express.put("/dataset/:id/:kind", bb.add);
		this.express.delete("/dataset/:id", bb.delete);
		this.express.post("/query", bb.query);
		this.express.get("/datasets", bb.list);
	}
